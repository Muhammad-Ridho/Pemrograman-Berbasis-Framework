                                ...
                                <tr key={todo.id}>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                            <button type="button" onClick={() => this.props.deleteTodo(todo.id)} class="btn btn-danger">Detele</button>
                                            <button type="button" onClick={() => this.props.toggleTodo(todo.id)} class="btn btn-success">Completed</button>
                                        </div>
